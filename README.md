...
[Руководство по разработке безопасных приложений с помощью Rust](https://github.com/ANSSI-FR/rust-guide) — Целью данного документа является предоставление советов и рекомендаций по безопасной разработке приложений с использованием языка программирования Rust.

[Список проектов, связанных с безопасностью](https://github.com/rust-secure-code/projects) — содержит список проектов, связанных с безопасностью.
---
...
<details>
<summary>**Ниже представлен список наиболее часто встречающихся уязвимостей в случае использования аутентификации по паролю:**</summary>
...
<details>
<summary>**Существуют разные источники для создания одноразовых паролей. Наиболее популярные:**</summary>
...
<details>
<summary>При аутентификации с помощью токена SP-приложение должно выполнить следующие проверки:</summary>
